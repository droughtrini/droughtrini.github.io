...
------------------------------------------------------*/
    ...
    // main directions
      map = new GMaps({
        el: '#map', lat: 51.4946983, lng: -0.1039607, zoom: 13, zoomControl : true, 
        zoomControlOpt: { style : 'SMALL', position: 'TOP_LEFT' }, panControl : false, scrollwheel: false
      });
    // add address markers
    map.addMarker({ lat: 51.4946983, lng: -0.1039607, title: 'BD InfoSys',
      infoWindow: { content: '<p>UAL, LCC Elephant and Castle SE1 6SB</p>' } });
